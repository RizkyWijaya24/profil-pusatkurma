...
<div class="max-w-3xl">
      ...
      <div>
        ...
        @if($contact->phone)
          <div class="flex items-center gap-2">
            <a href="https://api.whatsapp.com/send?phone={{ preg_replace('/\D/', '', $contact->phone) }}" target="_blank" rel="noopener noreferrer" class="font-bold text-emerald-700 hover:underline inline-flex items-center gap-1.5">
              {{ $contact->phone }}
  ...
  <div class="flex flex-wrap items-center justify-between gap-4">
    ...
    @if($contact->phone)
      <div>
        <a href="https://api.whatsapp.com/send?phone={{ preg_replace('/\D/', '', $contact->phone) }}&amp;text=Halo%20{{ urlencode($contact->name) }}%2C%20terima%20kasih%20telah%20menghubungi%20Pusat%20Kurma%20Premium%20Cianjur.%20Menanggapi%20pesan%20Anda%3A%20" 
           target="_blank" 
